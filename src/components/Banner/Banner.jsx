    ...
    return (
        <>
            ...
            <div className="w-full md:w-10/12 mx-auto md:ml-20 px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col md:flex-row gap-4 mt-2">
                {/* Left side – categories (unchanged) */}
                ...
                {/* Right side: top (carousel) + bottom (button bar) */}
                <div className="right flex-1 flex flex-col gap-4">
                    {/* Right-bottom: button bar (previously sticky, now just sits below carousel) */}
                    <div className="bg-white/95 rounded-md shadow-sm py-2">
